...
public class returnb extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/return book png.png"))); // NOI18N
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 300, 115, 50));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 150, 115, 30));
...
//st.excuteQuery("update issue set returnbook='YES'where studentID='"+studentid+"'and bookID= '"+bookid+"'");
         }
catch(Exception e){
